    ...
    <div className="home text-white">
      ...
      <nav className="navbar px-3">
        <div className="container-fluid d-flex justify-content-between">
          <a className="navbar-brand text-white" href="#">رهپو</a>
          <ul className="nav mx-auto">
            <li className="nav-item"><a className="nav-link text-white" href="#">صفحه اصلی</a></li>
            <li className="nav-item"><a className="nav-link text-white" href="#">درباره ما</a></li>
            <li className="nav-item"><a className="nav-link text-white" href="#">قوانین و مقررات</a></li>
          </ul>
          <div>
          ...
          <div className="row text-center">
            ...
            <div className="col-md-3 mb-4 mx-auto">
              <h5 className="fw-bold d-flex flex-column align-items-center">
                <img src="/logo.png" alt="لوگوی رهپو" className="footer-logo mb-2" />
              </h5>
              <p className="small">رهپو همراه مطمئن شما در مسیر مشاوره تحصیلی و رشد فردی.</p>
            </div>
